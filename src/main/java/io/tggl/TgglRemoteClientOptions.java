...
/**
 * Configuration options for TgglRemoteClient.
 */
public class TgglRemoteClientOptions {
    ...
    private TgglRemoteClientOptions(Builder builder) {
        ...
        this.initialContext = Collections.unmodifiableMap(new HashMap<>(builder.initialContext));
    ...
    public static class Builder {
        ...
        private long pollingIntervalMs = 0;
        ...
        public Builder initialContext(@NotNull Map<String, Object> initialContext) {
        ...
        public TgglRemoteClientOptions build() {
            if (timeoutMs < 0) {
            ...
            return new TgglRemoteClientOptions(this);
        }
    }
}
